...
export default function CreateSpotForm() {
  ...
  const showNameError = (title) => {
    if (!title) {
      return <p className="errors">Name is required</p>;
    }
  };
